...
const NavElement = (props) => {
    ...
    return (
        <li className={isActive ? 'active' : ''}>
          <a href={`#${id}`} data-toggle='collapse' aria-expanded='false' className='dropdown-toggle'>
        ...
        <nav id="sidebar">
          <Link to='/'>
            ...
            <ul className="list-unstyled CTAs">
                <li>
                    <a href="https://github.com/TitusCln/ScrumBoardSystem-react" className="article">GitHub Repo</a>
                </li>
            </ul>
        </nav>
